...
from io_ifc import (load_usgs_mapping, get_subwatershed, get_ids, 
                    get_rainfall_for_lids, load_and_aggregate_rainfall_by_division)
...
def main_visualization(test_dict):
    ...
    usgs_2_id, _, file_order = load_usgs_mapping(test_dict)
